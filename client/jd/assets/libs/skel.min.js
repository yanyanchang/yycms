		...
		var _ = {
			...
			getDevicePixelRatio: function() {
				...
				var e = "deviceType",
					...
					var safari_version=parseInt(RegExp.$1);
				if(r.indexOf('MicroMessenger')>-1 &&  _.vars[e] == "android" && safari_version >= 534) return 2;
				if(r.indexOf('QQ/')>-1 &&  _.vars[e] == "android" && safari_version >= 534) return 2;
				//if(r.indexOf('MicroMessenger')>-1 &&  _.vars[e] == "android" && safari_version = 537) return 1.5;
				if (_.vars[e] == "ios" || _.vars[e] == "mac" || _.vars[e] == "windows" || _.vars[e] == "android" && safari_version >= 537) return 1;
