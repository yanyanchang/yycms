...
function BizHoldBill(args){
    var ret = new IBiz(args) ;
    ret.request_code  = M_Q_HOLDBILL ;
    ret.response_code = M_R_HOLDBILL ;
...
var WETBizSDK = (
    function() {
        ...
        var _loginQuotedProxy = function(args) {
            ...
            _wsQuoted.open({
                ...
                onPush : function(wetPackage) {
                    ...
                    if (_subscrib && _subscrib[M_R_PUSH_QUOTE]) {
        ...
        return {
            ...
            passwordChange : function(newPWD,onsuccess,onfailure){
